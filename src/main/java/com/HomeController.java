...
public class HomeController {
    ...
    public String cal (@ModelAttribute("Basic_salary") int Basic_salary, @ModelAttribute("House_rent") int House_rent, @ModelAttribute("Medical_allowance") int Medical_allowance,@ModelAttribute("Conveyance") int Conveyance,@ModelAttribute("Incentive") int Incentive,@ModelAttribute("Festival_Bonus") int Festival_Bonus,/*@ModelAttribute("Festival_bonus") int Festival_bonus,*/ Model model)  {
